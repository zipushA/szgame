        ...
        <div className="hidden lg:block w-96 bg-white/10 backdrop-blur-md rounded-2xl p-6 border-2 border-gold/30 h-fit sticky top-6 animate-fade-in">
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <div className="border-t-2 border-gold/30 pt-4 mb-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white text-lg font-heebo">סה"כ פריטים:</span>
                  <span className="text-teal font-bold text-lg">
                    {cart.reduce((sum, item) => sum + item.quantity, 0)}
                  </span>
                </div>
            ...
            <div className="w-full bg-charcoal rounded-t-3xl p-6 max-h-[80vh] overflow-y-auto animate-fade-in-up">
              ...
              {cart.length === 0 ? (
                ...
                <>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2 bg-white/10 rounded-lg p-1">
                            <button
                              onClick={() => updateQuantity(item.id, -1)}
                              className="w-10 h-10 bg-crimson/80 hover:bg-crimson text-white rounded font-bold text-lg"
                            >
                              -
                            </button>
                            ...
                            <button
                              onClick={() => updateQuantity(item.id, 1)}
                              className="w-10 h-10 bg-teal/80 hover:bg-teal text-white rounded font-bold text-lg"
                            >
                              +
                            </button>
                          </div>
                  ...
                  <Button className="w-full h-14 bg-gradient-to-r from-crimson to-crimson/90 hover:from-crimson/90 hover:to-crimson text-white font-bold text-lg border-2 border-gold/50 shadow-xl hover:shadow-gold/50 transition-all duration-300">
                    השלם רכישה
                  </Button>
                </>
              )}
